...
<body>
	<div class="container text-center">
		...
		<div class="content-404">
			<img src="${pageContext.request.contextPath}/assets/images/404/accessdenied1.jpg" class="img-responsive" alt="" />
			<h1><b>OPPS!</b>Access Denied</h1>
			<p>Uh... You do not have permission to access this page.</p>
			<h2><a href="${pageContext.request.contextPath}/home">Bring me back Home</a></h2>
		</div>
	</div>
