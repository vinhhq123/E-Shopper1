                            ...
                            <div class="col-xs-12">
                                <div class="panel">
                                    ...
                                    <div class="panel-body table-responsive">
                                        <div class="row">
                                            <div class="col-sm-8">
                                                <form class="form-inline" role="form" action="<%=request.getContextPath()%>/proSearch" method="get">
                                        ...
                                        <div class="col-sm-4">
                                            <button type="button" class="btn btn-success" style="float: right" onclick="window.location = './admin/ProductAdd.jsp'">Add New Product</button>
<!--                                                <a href="<%=request.getContextPath()%>/addNewProduct" style="float: right"> Add new</a>-->
                                        </div>
                                    ...
                                    <table class="table table-striped" id="SettingListTable">
                                        <tr>
                                            ...
                                            <th onclick="sortTable(4)">Featured</th>
                                            <th onclick="sortTable(5)">Category</th>
                                            <th onclick="sortTable(6)">Saler</th>
                                            <th onclick="sortTable(7)">Product Status</th>
                                            <th onclick="sortTable(8)">Quantity</th>
                                            <th onclick="sortTable(9)">Updated Date</th>
                                            <th>Actions</th>
                                        </tr>
                                        <c:forEach items="${ProList}" var="con">
                                            <tr>
                                                ...
                                                <td><button type="button" class="btn-xs btn-primary" onclick="window.location = '<%=request.getContextPath()%>/proEdit?uid=${con.getUid()}'">Edit</button></td>
                                            </tr>
                                        </c:forEach>
                                    </table>
