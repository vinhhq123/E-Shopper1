                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="logo pull-left">
                                <a href="<%=request.getContextPath()%>/home"><img src="assets/images/home/logo.png" alt="" /></a>
                            </div>
                        </div>
                        <div class="col-sm-8">
                        ...
                        <div class="login-form"><!--login form-->
                            ...
                            <form action="resetpass" method="POST">
                                <c:if test="${not empty successMessage1}">
                                                    <b><h4 class="help-block" style="color: green" id="successEditMessage">${successMessage1}</h4></b>
                                                        <c:remove var="successMessage1"/>
                                                    <br>
                                </c:if>
                                    <input  type="hidden" class="form-control" name="email" value="${sessionScope.email}">
                                    <input type="text" placeholder="Your new password" name="newPass" value="${newPassValue}" required/> </br>
                                    <p style="color: red">${requestScope.fail2}</p>
                                    <input type="text" placeholder="Re-enter new password" name="reNewPass" value="${reNewPassValue}"  required/> </br>
