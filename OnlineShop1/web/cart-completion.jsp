        ...
        <section id="cart_items">           
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <span>
                            <h2 style="font-family: geneva;color: #FE980F;text-align: center">BẠN ĐÃ ĐẶT HÀNG THÀNH CÔNG</h2>
                            <p style="font-family: copperplate;text-align: center">Cảm ơn bạn đã lựa chọn sản phẩm của chúng tôi<br>Sản phẩm sẽ được chuyển đến bạn trong thời gian sớm nhất.<br>Chúc bạn có trải nghiệm sản phẩm tuyệt vời.</p>
                            <p style="text-align: center; font-size: 20px"> <i style="font-family: Brush Script MT">From Shop With Love <3</i></p>
                        </span> 
                        <table class="table-responsive cart_info table table-condensed">
                            <thead>
                                <tr class="cart_menu">
